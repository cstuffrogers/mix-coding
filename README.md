...
| 工具 | 文件 | 功能 | 平台 |
|------|------|------|------|
| **Claude Code 启动器** | [start-claude.bat](./start-claude.bat) | 一键启动 Claude Code（默认简体中文） | Windows |
...
```bash
# 核心工具（Phase 1）
npm install -D noleak pa11y-ci recheck-cli @lhci/cli knip    # npm 工具
