const ACTION_MESSAGES = {
  ...
  checkAPIConsistency:
    'API 契约一致性检查完成（OpenAPI 管线：redocly lint + 交叉验证 + openapi-typescript）',
  ...
  checkGate:
    '质量门禁检查完成：lint/typecheck/security/visual_regression/dependency_audit 全部通过',
  ...
  'mp-improve-codebase-architecture':
    'Matt Pocock /improve-codebase-architecture: 架构深化机会分析完成',
  'mp-git-guardrails': 'Matt Pocock /git-guardrails-claude-code: Git 危险命令拦截 Hook 已配置',

  // Web Design skills
  'web-design-declare-system':
    'Web Design Engineer: 设计系统声明完成（Palette/Typography/Spacing/Motion）',
  ...
  'web-design-verify':
    'Web Design Engineer: 设计交付检查完成（无控制台错误/无破损布局/对比度合格）',

  // AI-Friendly Web Design skill
  'ai-friendly-review':
    'AI-Friendly Web Design: 可访问性审查完成（语义HTML/ARIA/稳定定位器/表单最佳实践）',
  'ai-friendly-fix': 'AI-Friendly Web Design: 可访问性问题修复完成',

  // Awesome Design MD
  'awm-brand-list': 'Awesome Design MD: 列出可用品牌设计系统完成',
  'awm-brand-import':
    'Awesome Design MD: 品牌设计系统导入完成（颜色/字体/间距/组件已加载到工作流）',
  ...
  'huashu-expert-review':
    'Huashu 5 维度专家评审完成（philosophy/hierarchy/craft/functionality/originality）',
  ...
  // Interactive layer actions (SceneSelector)
  selectModes: '交互式模式选择完成',
  profile: '性能基线测量完成',

  // Update workflow actions
  scanUpdates: '资源扫描完成: npm/skill/CLI 版本已对比',
  'scan-updates': '资源扫描完成: npm/skill/CLI 版本已对比',
  detectConflicts: '冲突检测完成',
  'detect-conflicts': '冲突检测完成',
  autoUpdateSafe: '无冲突项已自动更新 (patch/minor)',
  'auto-update-safe': '无冲突项已自动更新 (patch/minor)',
  writeUpdateLog: '更新日志已写入 .claude/updates/',
  'write-update-log': '更新日志已写入 .claude/updates/',
  updateReport: '更新报告已生成',
  'update-report': '更新报告已生成',

  // Auto-generated by /check
    'session-catchup': 'session catchup 检查完成',
    'init-planning-files': 'init planning files 检查完成',
    'read-spec': 'read spec 检查完成',
    'gather-requirements': 'gather requirements 检查完成',
    'create-plan': 'create plan 检查完成',
    'create-findings': 'create findings 检查完成',
    'create-progress': 'create progress 检查完成',
    'confirm-attestation': 'confirm attestation 检查完成',
    'attest-plan': 'attest plan 检查完成',
    'display-summary': 'display summary 检查完成',
    'update-phase-status': 'update phase status 检查完成',
    'log-error': 'log error 检查完成',
    'append-progress': 'append progress 检查完成',
    'check-complete': 'check complete 检查完成',
    sessionCatchup: 'sessionCatchup 检查完成',
    initPlanningFiles: 'initPlanningFiles 检查完成',
    gatherRequirements: 'gatherRequirements 检查完成',
    createPlan: 'createPlan 检查完成',
    createFindings: 'createFindings 检查完成',
    createProgress: 'createProgress 检查完成',
    confirmAttestation: 'confirmAttestation 检查完成',
    attestPlan: 'attestPlan 检查完成',
    displaySummary: 'displaySummary 检查完成',
    updatePhaseStatus: 'updatePhaseStatus 检查完成',
    logError: 'logError 检查完成',
    appendProgress: 'appendProgress 检查完成',
    checkComplete: 'checkComplete 检查完成',
};
