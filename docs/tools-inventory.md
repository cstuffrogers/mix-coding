...
5. [28 个场景工作流（Scene JSON + Command Markdown）](#28-个场景工作流scene-json--command-markdown)
...
| **api-contract-check** | 有 | OpenAPI 标准管线（Redocly lint + 交叉验证 + openapi-typescript） | feature/design/new-project 等 28 个场景 |
...
## 28 个场景工作流（Scene JSON + Command Markdown）
